...
COLORS = ["red", "orange", "yellow", "green", "blue", "purple"] # colors of different cars
...
class CarManager:
    ...
    def create_car(self):
        ...
        if random_chance == 1:
            ...
            new_car.goto(300, random_y)# we now tell our newly generated cars to go 300px on the X axis and random_y we defined above.
            self.all_cars.append(new_car)# we can append our cars to our list of all cars in our CarManager Class

    def move_cars(self):
        '''
        This method moves all the cars. this method is going to go through our list of cars and it's going to move it by the move distance.
        '''
